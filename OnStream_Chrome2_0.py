...
class TestHomeScreen:
    def test_hero_screen(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            self.driver.find_element(By.XPATH,'//*[@id="HERO_CAROUSEL_CONTAINER"]/div/ul/li[4]/button').click()  # Fourth button click
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="HERO_CAROUSEL_CONTAINER"]/div/div/div/div[5]/div/div/div/div/div/div/button').click()  # Springs pledge learn more
            time.sleep(3)
    ...
    def test_news_and_weather(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            time.sleep(5)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_0"]/div/button/img').click()  # 1st box click play
            time.sleep(10)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="dish-bitmovin-player"]/div[4]/div/div[2]/div[1]/button/img').click()  # volume bar
            time.sleep(10)
            self.driver.find_element(By.XPATH,
                                     '///*[@id="dish-bitmovin-player"]/div[4]/div/div[2]/div[2]/button/img').click()  # caption click
            time.sleep(15)
            ...
            time.sleep(10)
            self.driver.find_element(By.XPATH,
                                     '//*[@id="ITEM_SWIMLANE_INNER_CONTAINER_0_2"]/div/button/img').click()  # fourth button click play
            time.sleep(5)
