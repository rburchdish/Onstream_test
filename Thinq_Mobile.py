...
def setup(request, onstream_url, custom_logo,mobile_platform,mobile_device_id):
    ...
    if mobile_platform.lower() == "Android".lower():
        ...
        desired_caps = {
            ...
            'xcodeOrgId': 'QPWT4523KW',
            'udid': '00008101-001A1D223410001E',
        }
...
class TestHomeScreen:
    def test_hero_screen(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            ##self.driver.fullscreen_window()
            ##time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[1]/img').click()  # close springs pledge
            time.sleep(3)
            ...
            time.sleep(3)
            advert_bottem = self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div/div[1]/div[2]/div/div[2]/div/div[1]')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', advert_bottem)  # Scroll Down to the Bottom
            time.sleep(3)
    ...
    def test_news_and_weather(self, onstream_version, onstream_url, client_setup):
        try:
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load
            time.sleep(3)
            first_video = self.driver.find_element(By.XPATH,'//*[@id="ITEM_0_0"]/div/button/img')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', first_video)  # Scroll Down to the Bottom
            time.sleep(3)
            ...
            time.sleep(10)'''
            ##self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[1]/img').click()  # 1 x
            self.driver.find_element(By.XPATH, '//*[@id="PLAYER_CLOSE_BTN"]/img').click()  # 1 x
            time.sleep(5)
            first_video = self.driver.find_element(By.XPATH,'//*[@id="ITEM_0_0"]/div/button/img')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', first_video)  # Scroll Down to the Bottom
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_0_1"]/div/button/img').click()  # second button click play
            time.sleep(10)
            ...
            time.sleep(5)
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div/div[2]/div[1]/button').click()  # more button
            time.sleep(5)
            third_video = self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[3]/div/div/button/img')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', third_video)  # Scroll Down to the Bottom
            time.sleep(10)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[3]/div/div/button/img').click()  # third button click play
            time.sleep(10)
            self.driver.find_element(By.XPATH, '//*[@id="PLAYER_CLOSE_BTN"]/img').click()  # third x
            time.sleep(4)
            fourth_video = self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[4]/div/div/button/img')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', fourth_video)  # Scroll Down to the Bottom
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[4]/div/div/button/img').click()  # fourth button click play
            time.sleep(10)
            self.driver.find_element(By.XPATH, '//*[@id="PLAYER_CLOSE_BTN"]/img').click()  # fourth button  x
            time.sleep(3)
            ##self.driver.find_element(By.XPATH,'//*[@id="SWIMLANE_INNER_CONTAINER_0"]/div[1]/div').click()  # right arrow
            ##time.sleep(3)
            fifth_video = self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[5]/div/div/button/img')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', fifth_video)  # Scroll Down to the Bottom
            time.sleep(5)
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[5]/div/div/button/img').click()  # fifth button click play
            time.sleep(3)
        ...
        ## assert False, "Element was not found"
            ...
            if len(loading_circle) > 0:
                ...
                body = [
                    {
                        "measurement": "OnStream", # this is one of the measurements
                        "tags": {
                            "Software": onstream_version,
                            "Test": 1,
                            "Pytest": self.name,
    ...
    def test_community_information(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            time.sleep(3)
            ##self.driver.fullscreen_window()
            ## remove all full screen on mobile devices
            time.sleep(3)
    ...
    def test_for_you(self, onstream_version, onstream_url, client_setup):
        try:
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load
            time.sleep(10)
            weather = self.driver.find_element(By.XPATH,'//*[@id="ITEM_1_0"]/div')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', weather)  # Scroll Down to the Bottom
            time.sleep(5)
            WebDriverWait(self.driver, 80).until(ec.presence_of_element_located((By.XPATH, '//*[@id="ITEM_1_0"]/div'))).click()  # weather
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[1]/img').click()  # close weather
            time.sleep(10)
            sports_one = self.driver.find_element(By.XPATH, '//*[@id="ITEM_1_1"]/div')  # defining for scrolling
            time.sleep(3)
            self.driver.execute_script('arguments[0].scrollIntoView(true);', sports_one)  # Scroll Down to the Bottom
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="ITEM_1_1"]/div').click()  # sports click
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]').click()  # current game
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div[2]/div/div[1]/img').click()  # close sport
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[1]').click()  # home
            time.sleep(3)
            more_button = self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div/div[2]/div[3]/button')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', more_button)  # Scroll Down to the Bottom
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div/div[2]/div[3]/button').click()  # more
            time.sleep(5)
            pet = self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[3]/div/div/div') # pet friendly
            self.driver.execute_script('arguments[0].scrollIntoView(true);', pet)  # Scroll Down to the Bottom
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[3]/div/div/div').click()  # more
            time.sleep(5)
            self.driver.find_element(By.XPATH,'//*[@id="undefined_MODAL_BUTTON"]').click()  # more info pet friendly
            time.sleep(5)
            self.driver.switch_to.window(self.driver.window_handles[0])  # Switch to previous tab
            ##self.driver.fullscreen_window()
            time.sleep(10)
            ...
            ##time.sleep(4)
            youre_home = self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[4]/div/div')  # yorue home
            self.driver.execute_script('arguments[0].scrollIntoView(true);', youre_home)  # Scroll Down to the Bottom
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[4]/div/div').click()  # youre home click
            time.sleep(3)
    ...
    def test_sports_buttons(self, onstream_version, onstream_url, client_setup):
            try:
                ...
                time.sleep(3)
                nba.click() #to click the nba click
                time.sleep(2)
                self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[1]').click()  # Close X  box
                time.sleep(2)
                self.driver.find_element(By.XPATH,'//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[1]').click()  # Home
...
class TestLiveTv:
    def test_modern_guide(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            time.sleep(5)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[1]/div/button[1]/div[2]').click()  # app settings
            time.sleep(4)
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[2]/div/div/div[3]/button[1]').click()  #tv guide format
            time.sleep(3)
            ...
            time.sleep(10)
            self.driver.find_element(By.XPATH,'//*[@id="ITEM_SWIMLANE_CONTAINER_ONNOW_0"]/div/div[1]/div/div/div').click() #play video
            time.sleep(3)
            ...
            ##time.sleep(15)
            play_buttons = self.driver.find_elements(By.XPATH, '//*[@id="ITEM_SWIMLANE_CONTAINER_ONNOW_0"]/div/div[1]/div/div/div')  # play video
    ...
    def test_classic_guide(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[2]/div/div/div[3]/button[1]').click()  # tv guide format
            time.sleep(3)
            self.driver.find_element(By.XPATH,  '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[2]/div/div/div[3]/button[2]/div[1]').click()  # classic guide
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.tv_guide))).click()  # tv guide
            time.sleep(10)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div/div/div/div[1]/div/div[2]/div/div/div[1]/div/div[1]/div/div/div[2]/div/div/div[1]/div/div').click()  # click on title
            time.sleep(10)
            ##self.driver.find_element(By.XPATH,'//*[@id="root"]/div[2]/div/div[2]/div/div[2]/div/button').click()  # watch now
            ##time.sleep(5)
            self.driver.find_element(By.XPATH,'//*[@id="dish-bitmovin-player"]/div[4]/div/div[2]/div[1]/button/img').click()  # Click volume button
            ...
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.play_live_tvguide))).click()
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.close_live_video))).click()
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div/div/div[1]/div[2]/div/div[1]/div[2]/div[2]/div/div[1]/div/div/div[2]/div/span[1]').is_displayed()  # title
            self.driver.find_element(By.XPATH,
                                     '//*[@id="root"]/div/div/div[1]/div[2]/div/div[1]/div[2]/div[2]/div/div[1]/div/div/div[2]/div/span[1]').is_displayed()  # description
...
class TestSettings:
    def test_settings(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.tv_guide))).click()  # tv guide
            time.sleep(5)
            ##self.driver.find_element(By.XPATH,'//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[3]').click()  # setttings button bottem
            self.driver.find_element(By.XPATH,'//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[6]').click()  # settings new
            time.sleep(4)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[1]/div/button[1]/div[2]').click()  # app settings
            time.sleep(3)
            ...
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[1]/div/button[1]/div[2]').click()  # app settings
            time.sleep(3)
            self.driver.find_element(By.XPATH,'//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[2]/div/div/div[5]/button[2]').click()  # temperature format
            time.sleep(3)
            ...
            weather = self.driver.find_element(By.XPATH, '//*[@id="ITEM_1_0"]/div')  # defining for scrolling
            self.driver.execute_script('arguments[0].scrollIntoView(true);', weather)  # Scroll Down to the Bottom
            self.driver.find_element(By.XPATH,'//*[@id="ITEM_1_0"]/div').click()  # weather
            time.sleep(10)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div[2]/div/div[1]/img').click()  # close weather
            time.sleep(10)
            self.driver.find_element(By.XPATH,'//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[6]').click()  # settings new
            ##self.driver.find_element(By.XPATH, UI_Constant.settings_button).click()  # settings button
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[1]/div/button[2]/div[2]/img').click()  # FAQ
            time.sleep(3)
            WebDriverWait(self.driver, 60).until( ec.presence_of_element_located((By.XPATH, UI_Constant.tv_guide))).click()  # tv guide
            time.sleep(3)
            self.driver.find_element(By.XPATH, '//*[@id="HEADER_CONTAINER"]/div[2]/nav/div/button[3]').click()  # setttings button bottem
            time.sleep(4)
            self.driver.find_element(By.XPATH, '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[1]/div/button[3]/div[2]').click()  # legal and about
            time.sleep(5)
            ...
            time.sleep(5)
            self.driver.find_element(By.XPATH,   '//*[@id="root"]/div/div/div[1]/div[2]/div/div/div[2]/div/div/div[1]/img').click()  # back button
            time.sleep(10)
