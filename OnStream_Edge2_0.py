...
def setup(request, onstream_url, custom_logo):
    ...
    driver = webdriver.Edge(executable_path='/Users/admin/Downloads/edgedriver_mac64/msedgedriver',capabilities={ "platformName": 'mac os x', })
    dishtv = onstream_url
    driver.get(dishtv)
...
class TestHomeScreen:
    ...
    def test_news_and_weather(self, onstream_version, onstream_url, client_setup):
        try:
            ...
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH,'///*[@id="dish-bitmovin-player"]/div[4]/div/div[2]/div[2]/button/img'))).click()  # caption click
